...
public class AuditeurCNAMTest extends junit.framework.TestCase {
    ...
    public void test_pour_un_caractere() {
        question3.AuditeurCNAM auditeur1 = new question3.AuditeurCNAM("Cynti@",
                "Aad", "10638f");
        assertEquals(" Cynthia Aad ", "Cynti@", auditeur1.nom());
        assertEquals(" Cynthia Aad", "Aad", auditeur1.prenom());
        assertEquals(" nom avec caractere (@ devient _) ? ", "cynti__a",
            auditeur1.login());
